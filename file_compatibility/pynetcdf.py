...
This module is a Pure Python module originally written by Roberto De
Almeida <roberto@dealmeida.net> called pupynere.py, and licensed with
an MIT license. Modifications since v1.0 are by Gopal Narayanan
...
class netcdf_variable(object):
    ...
    def get(self):
        if self.dimensions:
            if self._typecode == 'c':
                return self.data.tostring().strip()
            return self.data
        else:
